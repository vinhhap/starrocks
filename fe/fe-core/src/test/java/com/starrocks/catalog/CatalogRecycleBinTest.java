...
public class CatalogRecycleBinTest {
    ...
    public void testTimeExpiredWithRetentionPeriod(@Mocked GlobalStateMgr globalStateMgr, @Mocked EditLog editLog) {
        ...
        Partition p1 = new Partition(101, "p1", new MaterializedIndex(), null);
    ...
    public void testGetAdjustedRecycleTimestampWithRetentionPeriod() {
        ...
        Partition p1 = new Partition(201, "p1", new MaterializedIndex(), null);
        RecycleRangePartitionInfo info1 =
                new RecycleRangePartitionInfo(dbId, tableId, p1, null, dataProperty, (short) 2, false, null);
        info1.setRecoverable(false);
        ...
        new Partition(301, "p2", new MaterializedIndex(), null);
        Partition p2 = new Partition(301, "p2", new MaterializedIndex(), null);
        ...
        Assert.assertNotNull(recycleBin.idToRecycleTime.get(p1.getId()));
        Assert.assertEquals(recycleBin.idToRecycleTime.get(p1.getId()).longValue(), adjustedTime1);
        ...
        Assert.assertEquals(0, adjustedTime2);
    }
}
