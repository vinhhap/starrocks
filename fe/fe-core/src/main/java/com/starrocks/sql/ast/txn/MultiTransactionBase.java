...
public class MultiTransactionBase extends StatementBase  {
    protected static final long UNINITIALIZED_TXN_ID = -1;

    protected final long txnId;

    protected MultiTransactionBase(long txnId, NodePosition pos) {
        super(pos);
        this.txnId = txnId;
    }
