...
public class NodeSelector {
     ...
     */
    public Long seqChooseComputeIdFromWarehouse(long warehouseId) throws UserException {
        ...
        throw new UserException("No compute node alive in warehouse: " + warehouseId);
    }
